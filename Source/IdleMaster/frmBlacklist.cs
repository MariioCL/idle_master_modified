...
namespace IdleMaster
{
    public partial class frmBlacklist : Form
    {
        ...
        private void frmBlacklist_Load(object sender, EventArgs e)
        {
            ...
            btnBack.Text = localization.strings.back;
        ...
        private void runtimeCustomThemeBlacklist()
        {
            ...
            // Button
            btnAdd.FlatStyle = btnBack.FlatStyle = btnSave.FlatStyle = btnRemove.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            btnAdd.BackColor = btnBack.BackColor = btnSave.BackColor = btnRemove.BackColor = colorBgd;
            btnAdd.ForeColor = btnBack.ForeColor = btnSave.BackColor = btnRemove.ForeColor = colorTxt;
